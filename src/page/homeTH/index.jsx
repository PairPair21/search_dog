        ...
        <div>
            ...
            <section className="bg-bottom h-[95vh] bg-cover bg-[url('/public/assets/pexels-david-kittel-838409.jpg')] bg-gray-700 bg-blend-multiply">
                <div className=" px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-60">
                    <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white sm:text-5xl md:text-5xl lg:text-6xl">ค้นหาเพื่อนที่ใช่</h1>
                    <p className="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:text-xl sm:px-16 lg:px-48">ความสุขอย่างหนึ่งของการได้อยู่กับสุนัขคือการแสดงออกอย่างเป็นธรรมชาติในสิ่งที่มันรู้สึก</p>
            ...
            <section className="pt-[40px] h-[100vh] mb-[20px]" id="learn">
                <div className="pl-[40px] text-start">
                    <h1 className="text-2xl lg:text-4xl bg-pink" >BokBok คืออะไร...</h1>
                    <p className="text-lg lg:text-2xl mt-[20px]">BokBok คือเว็บไซต์ที่จะช่วยคุณค้นหาสายพันธุ์ที่ใช่สำหรับตัวตนของคุณ โดยการระบุข้อมูลอย่างน้อยหนึ่งข้อมูล แล้วระบบจะแนะนำสุนัขสูงสุด 20 สายพันธุ์ให้กับคุณ</p>
                </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-6">
                    <div className="flex flex-col bg-white m-[10px] h-[380px] sm:h-[350px] lg:h-[350px] 2xl:h-[500px] " >
                        <h1 className="m-[10px] border-b-[1px] text-center pb-[10px] font-mono text-lg sm:text-xl lg:text-2xl font-bold">Breed</h1>
                        <p className="mx-[10px] h-[150px] lg:h-[160px] 2xl:h-[275px] text-base sm:text-lg  lg:text-lg ">ค้นหาข้อมูลสายพันธุ์ด้วยชื่อของสายพันธุ์ด้วยภาษาอังกฤษ เพื่อศึกษาข้อมูลของแต่ละสายพันธุ์ และต้องไม่ลืมว่าแต่ละสายพันธุ์ต้องการการเลี้ยงดูที่แตกต่างกัน ไม่ได้ต่างกันเพียงรูปลักษณ์ภายนอกเท่านั้น</p>
                        <div className="grid grid-cols-2 grid-rows-2 mt-[80px] sm:mt-[40px] lg:mt-[10px] 2xl:mb-[20px]">
                    ...
                    <div className="flex flex-col bg-white m-[10px] h-[380px] sm:h-[350px] lg:h-[350px] 2xl:h-[500px]">
                        ...
                        <p className="mx-[10px] h-[150px] lg:h-[160px] 2xl:h-[275px] text-base sm:text-lg  lg:text-lg">ระบุเกี่ยวกับธรรมชาติของการเห่าในสายพันธุ์นั้น จากระดับ 1 ถึงระดับ 5 เป็นเรื่องที่ต้องพิจารณาหากมีข้อจำกัดด้านที่อยู่อาศัย</p>
                        <img className="w-[3em] sm:w-[4em] lg:w-[4.5em] 2xl:w-[5em] self-center mt-[100px] sm:mt-[40px] lg:mt-[10px] 2xl:mt-[10px]" src="assets/guard-dog-svgrepo-com.png" alt="" />
                    </div>
                    <div className="flex flex-col bg-white m-[10px] h-[450px] sm:h-[400px] lg:h-[350px] 2xl:h-[500px]">
                        <h3 className="m-[10px] border-b-[1px] text-center pb-[10px] font-mono text-lg lg:text-2xl font-bold">Size</h3>
                        <p className="mx-[10px] h-[225px] lg:h-[160px] 2xl:h-[275px] text-lg sm:text-xl  lg:text-xl">เลือกขนาดของสุนัขให้เหมาะกับพื้นที่ที่อยู่อาศัย</p>
                        <div className="flex self-center mt-[70px] sm:mt-[20px] lg:mt-[10px] 2xl:mb-[10px]">
                    ...
                    <div className="flex flex-col bg-white m-[10px] h-[450px] sm:h-[400px] lg:h-[400px] 2xl:h-[500px]">
                        <h3 className="m-[10px] border-b-[1px] text-center pb-[10px] font-mono text-lg sm:text-xl lg:text-2xl font-bold">Energy</h3>
                        <p className="mx-[10px] h-[225px] lg:h-[195px] 2xl:h-[275px] text-base sm:text-lg lg:text-lg 2xl:leading-[1.4rem]">ค่าพลังงานของสุนัข โดยมีลำดับ 1 ถึง 4 จากน้อยไปมาก หากสุนัขมีพลังงานที่สูงนั้นอาจต้องการการดูแลเรื่องการพาไปเดินเล่นหรือมีการเล่นด้วยที่มากเป็นพิเศษ และสุนัขที่มีพลังงานสูงนั้นอาจเล่นแรงเกิดไปจนทำให้เกิดการบาดเจ็บจากการเล่นโดยที่ไม่ได้ตั้งใจได้</p>
                        <img className="w-[4em] sm:w-[5em] lg:w-[5em] 2xl:w-[6em] self-center mt-[80px] sm:mt-[30px] lg:mt-[30px] 2xl:mt-[30px]" src="assets/man-throwing-a-disc-and-dog-jumping-to-catch-it-svgrepo-com.png" alt="" />
                    </div>
                    <div className="flex flex-col bg-white m-[10px] h-[480px] sm:h-[400px] lg:h-[400px] 2xl:h-[500px]">
                        <h3 className="m-[10px] border-b-[1px] text-center pb-[10px] font-mono text-lg sm:text-xl lg:text-2xl font-bold">Trainability</h3>
                        <p className="mx-[10px] h-[150px] lg:h-[195px] 2xl:h-[300px] text-base sm:text-lg  lg:text-lg 2xl:leading-6">เป็นค่าความยากต่อการฝึกฝน จากระดับ 1 ถึง 5 ค่านี้ไม่ได้บ่งบอกถึงความฉลาดของสายพันธุ์เนื่องจากมีข้อพิจารณาเพิ่มเติมอยู่ด้วย อาธิความสามารถในการโฟกัสต่อสิ่งใดสิ่งหนึ่ง ความต้องการเป็นอิสระ หรือแม้แต่ความต้องการอยู่อย่างสันโดษ นั้นก็เป็นปัจจัยหนึ่งในการพิจารณาด้วยเช่นกัน</p>
                        <img className="w-[3em] sm:w-[4em] lg:w-[4.3em] 2xl:w-[5em] mt-[200px] sm:mt-[90px] 2xl:mt-[20px] self-center lg:mt-[40px]" src="assets/dog-in-front-of-a-man-svgrepo-com.png" alt="" />
                    </div>
                    <div className="flex flex-col bg-white m-[10px] h-[480px] sm:h-[400px] lg:h-[400px] 2xl:h-[500px]">
                        <div>
                        ...
                        <p className="mx-[10px] h-[150px] lg:h-[195px] 2xl:h-[300px] text-base sm:text-lg  lg:text-lg 2xl:leading-[1.4rem]">ค่าการตอบสนองต่อการปกป้องเจ้าของเมื่อพบเจอสิ่งแปลกหน้า แต่ทั้งนี้ไม่ได้หมายความว่าสุนัขจะจู่โจมไปที่คนแปลกหน้า การต่อสนองนั้นจะขึ้นอยู่กับการฝึกสุนัข</p>
                        </div>
                        <img className="w-[3em] sm:w-[4em] lg:w-[4.5em] 2xl:w-[5em] mt-[200px] sm:mt-[90px] 2xl:mt-[20px] self-center lg:mt-[30px]" src="assets/dog-puppy-and-his-owner-looking-to-opposite-directions-svgrepo-com.png" alt="" />
                    </div>
                </div>
                <div className="w-[100%] h-[150px] bg-yellow p-[40px] ">
                    <div className="mb-[10px]">อยากรู้อายุของสุนัขของคุณเมื่อเทียบกับอายุของมนุษย์มั้ย?</div>
                    <div className="text-center">หาเล้ย!!</div>
                    <div className=" mx-[20px] flex flex-col items-center lg:flex-row justify-center pb-[20px]">
                        ...
                        placeholder="Dog age" />
                        <button className="w-[150px] h-[50px] bg-[#3C69E8] my-[10px] hover:text-gray-900" onClick={handleDogAgeClick}>เปลี่ยน&#8652;</button>
